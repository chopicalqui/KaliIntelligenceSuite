#!/usr/bin/python3
"""
this file implements all unittests for collector udpnmapdomain
"""
...
from collectors.os.modules.scan.udpnmapdomain import CollectorClass as NmapCollector
