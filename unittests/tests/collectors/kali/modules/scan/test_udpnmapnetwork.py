#!/usr/bin/python3
"""
this file implements all unittests for collector udpnmapnetwork
"""
...
from collectors.os.modules.scan.udpnmapnetwork import CollectorClass as UdpNmapCollector
...
class BaseUdpNmapCollectorTestCase(BaseNmapCollectorTestCase):
    ...
    def __init__(self, test_name: str, **kwargs):
        super().__init__(test_name,
                         collector_name="udpnmapnetwork",
                         collector_class=UdpNmapCollector)
