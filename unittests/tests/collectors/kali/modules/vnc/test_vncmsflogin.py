...
from collectors.os.modules.vnc.vncmsflogin import CollectorClass as VncMsfLoginCollector
...
class VncMsfLoginCollectorTestCase(BaseKaliCollectorTestCase):
    ...
    def __init__(self, test_name: str, **kwargs):
        super().__init__(test_name,
                         collector_name="vncmsflogin",
                         collector_class=VncMsfLoginCollector)
    ...
    def get_command_text_outputs() -> List[str]:
        ...
        :return:
        """
        return ["""[*] 127.0.0.1:5900        - 127.0.0.1:5900 - Starting VNC login sweep
[-] 127.0.0.1:5900        - 127.0.0.1:5900 - Login Successful: [REDACTED]
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with self._engine.session_scope() as session:
                ...
                command = self.create_command(session=session,
                                              ...
                                              command=["msfconsole", '-q', '-x', 'use auxiliary/scanner/vnc/vnc_login;set RHOSTS=127.0.0.1;run;exit'],
                                              collector_name_str="vncmsflogin",
            ...
            with self._engine.session_scope() as session:
                ...
                self.assertEqual("[REDACTED]", credential.password)
                self.assertEqual(CredentialType.cleartext, credential.type)
