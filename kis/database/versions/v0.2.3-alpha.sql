...
--
-- Name: asymmetricalgorithm; Type: TYPE; Schema: public; Owner: kis
--

CREATE TYPE public.asymmetricalgorithm AS ENUM (
    'rsa',
    'dsa',
    'ecdsa',
    'dss',
...
ALTER TYPE public.asymmetricalgorithm OWNER TO kis;
...
--
-- Name: hashalgorithm; Type: TYPE; Schema: public; Owner: kis
--
...
ALTER TYPE public.hashalgorithm OWNER TO kis;
...
CREATE TABLE public.cert_info (
    ...
    signature_asym_algorithm public.asymmetricalgorithm NOT NULL,
    signature_bits integer NOT NULL,
...
--
-- Name: vhost_mapping; Type: TABLE; Schema: public; Owner: kis
--

CREATE TABLE public.vhost_mapping (
    id integer NOT NULL,
    service_id integer NOT NULL,
    host_name_id integer NOT NULL,
    creation_date timestamp without time zone NOT NULL,
...
ALTER TABLE public.vhost_mapping OWNER TO kis;

--
-- Name: vhost_mapping_id_seq; Type: SEQUENCE; Schema: public; Owner: kis
--

CREATE SEQUENCE public.vhost_mapping_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.vhost_mapping_id_seq OWNER TO kis;

--
-- Name: vhost_mapping_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: kis
--

ALTER SEQUENCE public.vhost_mapping_id_seq OWNED BY public.vhost_mapping.id;
...
--
-- Name: vhost_mapping id; Type: DEFAULT; Schema: public; Owner: kis
--

ALTER TABLE ONLY public.vhost_mapping ALTER COLUMN id SET DEFAULT nextval('public.vhost_mapping_id_seq'::regclass);
...
COPY public.cert_info (id, serial_number, common_name, issuer_name, signature_asym_algorithm, signature_bits, hash_algorithm, cert_type, valid_from, valid_until, extension_info, creation_date, last_modified, service_id, company_id, host_name_id) FROM stdin;
\.
...
236	TLS_KRB5_EXPORT_WITH_DES_CBC_40_MD5	\N	\N	0	41	insecure
237	TLS_KRB5_EXPORT_WITH_DES_CBC_40_SHA	\N	\N	0	38	insecure
238	TLS_KRB5_EXPORT_WITH_RC2_CBC_40_MD5	\N	\N	0	42	insecure
239	TLS_KRB5_EXPORT_WITH_RC2_CBC_40_SHA	\N	\N	0	39	insecure
240	TLS_KRB5_EXPORT_WITH_RC4_40_MD5	\N	\N	0	43	insecure
241	TLS_KRB5_EXPORT_WITH_RC4_40_SHA	\N	\N	0	40	insecure
242	TLS_KRB5_WITH_3DES_EDE_CBC_MD5	\N	\N	0	35	insecure
243	TLS_KRB5_WITH_3DES_EDE_CBC_SHA	\N	\N	0	31	weak
244	TLS_KRB5_WITH_DES_CBC_MD5	\N	\N	0	34	insecure
245	TLS_KRB5_WITH_DES_CBC_SHA	\N	\N	0	30	insecure
246	TLS_KRB5_WITH_IDEA_CBC_MD5	\N	\N	0	37	insecure
247	TLS_KRB5_WITH_IDEA_CBC_SHA	\N	\N	0	33	weak
248	TLS_KRB5_WITH_RC4_128_MD5	\N	\N	0	36	insecure
249	TLS_KRB5_WITH_RC4_128_SHA	\N	\N	0	32	insecure
250	TLS_NULL_WITH_NULL_NULL	\N	\N	0	0	insecure
251	TLS_PSK_DHE_WITH_AES_128_CCM_8	TLS_DHE_PSK_AES_128_CCM_8	DHE-PSK-AES128-CCM8	192	170	secure
252	TLS_PSK_DHE_WITH_AES_256_CCM_8	TLS_DHE_PSK_AES_256_CCM_8	DHE-PSK-AES256-CCM8	192	171	secure
253	TLS_PSK_WITH_3DES_EDE_CBC_SHA	TLS_PSK_3DES_EDE_CBC_SHA1	PSK-3DES-EDE-CBC-SHA	0	139	weak
254	TLS_PSK_WITH_AES_128_CBC_SHA	TLS_PSK_AES_128_CBC_SHA1	PSK-AES128-CBC-SHA	0	140	weak
255	TLS_PSK_WITH_AES_128_CBC_SHA256	TLS_PSK_AES_128_CBC_SHA256	PSK-AES128-CBC-SHA256	0	174	weak
256	TLS_PSK_WITH_AES_128_CCM	TLS_PSK_AES_128_CCM	PSK-AES128-CCM	192	164	weak
257	TLS_PSK_WITH_AES_128_CCM_8	TLS_PSK_AES_128_CCM_8	PSK-AES128-CCM8	192	168	weak
258	TLS_PSK_WITH_AES_128_GCM_SHA256	TLS_PSK_AES_128_GCM_SHA256	PSK-AES128-GCM-SHA256	0	168	weak
259	TLS_PSK_WITH_AES_256_CBC_SHA	TLS_PSK_AES_256_CBC_SHA1	PSK-AES256-CBC-SHA	0	141	weak
260	TLS_PSK_WITH_AES_256_CBC_SHA384	TLS_PSK_AES_256_CBC_SHA384	PSK-AES256-CBC-SHA384	0	175	weak
261	TLS_PSK_WITH_AES_256_CCM	TLS_PSK_AES_256_CCM	PSK-AES256-CCM	192	165	weak
262	TLS_PSK_WITH_AES_256_CCM_8	TLS_PSK_AES_256_CCM_8	PSK-AES256-CCM8	192	169	weak
263	TLS_PSK_WITH_AES_256_GCM_SHA384	TLS_PSK_AES_256_GCM_SHA384	PSK-AES256-GCM-SHA384	0	169	weak
264	TLS_PSK_WITH_ARIA_128_CBC_SHA256	\N	\N	192	100	weak
265	TLS_PSK_WITH_ARIA_128_GCM_SHA256	\N	\N	192	106	weak
266	TLS_PSK_WITH_ARIA_256_CBC_SHA384	\N	\N	192	101	weak
267	TLS_PSK_WITH_ARIA_256_GCM_SHA384	\N	\N	192	107	weak
268	TLS_PSK_WITH_CAMELLIA_128_CBC_SHA256	TLS_PSK_CAMELLIA_128_CBC_SHA256	PSK-CAMELLIA128-SHA256	192	148	weak
269	TLS_PSK_WITH_CAMELLIA_128_GCM_SHA256	TLS_PSK_CAMELLIA_128_GCM_SHA256	\N	192	142	weak
270	TLS_PSK_WITH_CAMELLIA_256_CBC_SHA384	TLS_PSK_CAMELLIA_256_CBC_SHA384	PSK-CAMELLIA256-SHA384	192	149	weak
271	TLS_PSK_WITH_CAMELLIA_256_GCM_SHA384	TLS_PSK_CAMELLIA_256_GCM_SHA384	\N	192	143	weak
272	TLS_PSK_WITH_CHACHA20_POLY1305_SHA256	TLS_PSK_CHACHA20_POLY1305	PSK-CHACHA20-POLY1305	204	171	weak
273	TLS_PSK_WITH_NULL_SHA	TLS_PSK_NULL_SHA1	PSK-NULL-SHA	0	44	insecure
274	TLS_PSK_WITH_NULL_SHA256	TLS_PSK_NULL_SHA256	PSK-NULL-SHA256	0	176	insecure
275	TLS_PSK_WITH_NULL_SHA384	TLS_PSK_NULL_SHA384	PSK-NULL-SHA384	0	177	insecure
276	TLS_PSK_WITH_RC4_128_SHA	TLS_PSK_ARCFOUR_128_SHA1	\N	0	138	insecure
277	TLS_RSA_EXPORT_WITH_DES40_CBC_SHA	\N	\N	0	8	insecure
278	TLS_RSA_EXPORT_WITH_RC2_CBC_40_MD5	\N	\N	0	6	insecure
279	TLS_RSA_EXPORT_WITH_RC4_40_MD5	\N	\N	0	3	insecure
280	TLS_RSA_PSK_WITH_3DES_EDE_CBC_SHA	TLS_RSA_PSK_3DES_EDE_CBC_SHA1	RSA-PSK-3DES-EDE-CBC-SHA	0	147	weak
281	TLS_RSA_PSK_WITH_AES_128_CBC_SHA	TLS_RSA_PSK_AES_128_CBC_SHA1	RSA-PSK-AES128-CBC-SHA	0	148	weak
282	TLS_RSA_PSK_WITH_AES_128_CBC_SHA256	TLS_RSA_PSK_AES_128_CBC_SHA256	RSA-PSK-AES128-CBC-SHA256	0	182	weak
283	TLS_RSA_PSK_WITH_AES_128_GCM_SHA256	TLS_RSA_PSK_AES_128_GCM_SHA256	RSA-PSK-AES128-GCM-SHA256	0	172	weak
284	TLS_RSA_PSK_WITH_AES_256_CBC_SHA	TLS_RSA_PSK_AES_256_CBC_SHA1	RSA-PSK-AES256-CBC-SHA	0	149	weak
285	TLS_RSA_PSK_WITH_AES_256_CBC_SHA384	TLS_RSA_PSK_AES_256_CBC_SHA384	RSA-PSK-AES256-CBC-SHA384	0	183	weak
286	TLS_RSA_PSK_WITH_AES_256_GCM_SHA384	TLS_RSA_PSK_AES_256_GCM_SHA384	RSA-PSK-AES256-GCM-SHA384	0	173	weak
287	TLS_RSA_PSK_WITH_ARIA_128_CBC_SHA256	\N	\N	192	104	weak
288	TLS_RSA_PSK_WITH_ARIA_128_GCM_SHA256	\N	\N	192	110	weak
289	TLS_RSA_PSK_WITH_ARIA_256_CBC_SHA384	\N	\N	192	105	weak
290	TLS_RSA_PSK_WITH_ARIA_256_GCM_SHA384	\N	\N	192	111	weak
291	TLS_RSA_PSK_WITH_CAMELLIA_128_CBC_SHA256	TLS_RSA_PSK_CAMELLIA_128_CBC_SHA256	RSA-PSK-CAMELLIA128-SHA256	192	152	weak
292	TLS_RSA_PSK_WITH_CAMELLIA_128_GCM_SHA256	TLS_RSA_PSK_CAMELLIA_128_GCM_SHA256	\N	192	146	weak
293	TLS_RSA_PSK_WITH_CAMELLIA_256_CBC_SHA384	TLS_RSA_PSK_CAMELLIA_256_CBC_SHA384	RSA-PSK-CAMELLIA256-SHA384	192	153	weak
294	TLS_RSA_PSK_WITH_CAMELLIA_256_GCM_SHA384	TLS_RSA_PSK_CAMELLIA_256_GCM_SHA384	\N	192	147	weak
295	TLS_RSA_PSK_WITH_CHACHA20_POLY1305_SHA256	TLS_RSA_PSK_CHACHA20_POLY1305	RSA-PSK-CHACHA20-POLY1305	204	174	weak
296	TLS_RSA_PSK_WITH_NULL_SHA	TLS_RSA_PSK_NULL_SHA1	RSA-PSK-NULL-SHA	0	46	insecure
297	TLS_RSA_PSK_WITH_NULL_SHA256	TLS_RSA_PSK_NULL_SHA256	RSA-PSK-NULL-SHA256	0	184	insecure
298	TLS_RSA_PSK_WITH_NULL_SHA384	TLS_RSA_PSK_NULL_SHA384	RSA-PSK-NULL-SHA384	0	185	insecure
299	TLS_RSA_PSK_WITH_RC4_128_SHA	TLS_RSA_PSK_ARCFOUR_128_SHA1	\N	0	146	insecure
300	TLS_RSA_WITH_3DES_EDE_CBC_SHA	TLS_RSA_3DES_EDE_CBC_SHA1	DES-CBC3-SHA	0	10	weak
301	TLS_RSA_WITH_AES_128_CBC_SHA	TLS_RSA_AES_128_CBC_SHA1	AES128-SHA	0	47	weak
302	TLS_RSA_WITH_AES_128_CBC_SHA256	TLS_RSA_AES_128_CBC_SHA256	AES128-SHA256	0	60	weak
303	TLS_RSA_WITH_AES_128_CCM	TLS_RSA_AES_128_CCM	AES128-CCM	192	156	weak
304	TLS_RSA_WITH_AES_128_CCM_8	TLS_RSA_AES_128_CCM_8	AES128-CCM8	192	160	weak
305	TLS_RSA_WITH_AES_128_GCM_SHA256	TLS_RSA_AES_128_GCM_SHA256	AES128-GCM-SHA256	0	156	weak
306	TLS_RSA_WITH_AES_256_CBC_SHA	TLS_RSA_AES_256_CBC_SHA1	AES256-SHA	0	53	weak
307	TLS_RSA_WITH_AES_256_CBC_SHA256	TLS_RSA_AES_256_CBC_SHA256	AES256-SHA256	0	61	weak
308	TLS_RSA_WITH_AES_256_CCM	TLS_RSA_AES_256_CCM	AES256-CCM	192	157	weak
309	TLS_RSA_WITH_AES_256_CCM_8	TLS_RSA_AES_256_CCM_8	AES256-CCM8	192	161	weak
310	TLS_RSA_WITH_AES_256_GCM_SHA384	TLS_RSA_AES_256_GCM_SHA384	AES256-GCM-SHA384	0	157	weak
311	TLS_RSA_WITH_ARIA_128_CBC_SHA256	\N	\N	192	60	weak
312	TLS_RSA_WITH_ARIA_128_GCM_SHA256	\N	\N	192	80	weak
313	TLS_RSA_WITH_ARIA_256_CBC_SHA384	\N	\N	192	61	weak
314	TLS_RSA_WITH_ARIA_256_GCM_SHA384	\N	\N	192	81	weak
315	TLS_RSA_WITH_CAMELLIA_128_CBC_SHA	TLS_RSA_CAMELLIA_128_CBC_SHA1	CAMELLIA128-SHA	0	65	weak
316	TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256	TLS_RSA_CAMELLIA_128_CBC_SHA256	CAMELLIA128-SHA256	0	186	weak
317	TLS_RSA_WITH_CAMELLIA_128_GCM_SHA256	TLS_RSA_CAMELLIA_128_GCM_SHA256	\N	192	122	weak
318	TLS_RSA_WITH_CAMELLIA_256_CBC_SHA	TLS_RSA_CAMELLIA_256_CBC_SHA1	CAMELLIA256-SHA	0	132	weak
319	TLS_RSA_WITH_CAMELLIA_256_CBC_SHA256	TLS_RSA_CAMELLIA_256_CBC_SHA256	CAMELLIA256-SHA256	0	192	weak
320	TLS_RSA_WITH_CAMELLIA_256_GCM_SHA384	TLS_RSA_CAMELLIA_256_GCM_SHA384	\N	192	123	weak
321	TLS_RSA_WITH_DES_CBC_SHA	\N	\N	0	9	insecure
322	TLS_RSA_WITH_IDEA_CBC_SHA	\N	IDEA-CBC-SHA	0	7	weak
323	TLS_RSA_WITH_NULL_MD5	TLS_RSA_NULL_MD5	NULL-MD5	0	1	insecure
324	TLS_RSA_WITH_NULL_SHA	TLS_RSA_NULL_SHA1	NULL-SHA	0	2	insecure
325	TLS_RSA_WITH_NULL_SHA256	TLS_RSA_NULL_SHA256	NULL-SHA256	0	59	insecure
326	TLS_RSA_WITH_RC4_128_MD5	TLS_RSA_ARCFOUR_128_MD5	\N	0	4	insecure
327	TLS_RSA_WITH_RC4_128_SHA	TLS_RSA_ARCFOUR_128_SHA1	\N	0	5	insecure
328	TLS_RSA_WITH_SEED_CBC_SHA	\N	SEED-SHA	0	150	weak
329	TLS_SM4_CCM_SM3	\N	\N	0	199	insecure
330	TLS_SM4_GCM_SM3	\N	\N	0	198	insecure
331	TLS_SRP_SHA_DSS_WITH_3DES_EDE_CBC_SHA	TLS_SRP_SHA_DSS_3DES_EDE_CBC_SHA1	SRP-DSS-3DES-EDE-CBC-SHA	192	28	weak
332	TLS_SRP_SHA_DSS_WITH_AES_128_CBC_SHA	TLS_SRP_SHA_DSS_AES_128_CBC_SHA1	SRP-DSS-AES-128-CBC-SHA	192	31	weak
333	TLS_SRP_SHA_DSS_WITH_AES_256_CBC_SHA	TLS_SRP_SHA_DSS_AES_256_CBC_SHA1	SRP-DSS-AES-256-CBC-SHA	192	34	weak
334	TLS_SRP_SHA_RSA_WITH_3DES_EDE_CBC_SHA	TLS_SRP_SHA_RSA_3DES_EDE_CBC_SHA1	SRP-RSA-3DES-EDE-CBC-SHA	192	27	weak
335	TLS_SRP_SHA_RSA_WITH_AES_128_CBC_SHA	TLS_SRP_SHA_RSA_AES_128_CBC_SHA1	SRP-RSA-AES-128-CBC-SHA	192	30	weak
336	TLS_SRP_SHA_RSA_WITH_AES_256_CBC_SHA	TLS_SRP_SHA_RSA_AES_256_CBC_SHA1	SRP-RSA-AES-256-CBC-SHA	192	33	weak
337	TLS_SRP_SHA_WITH_3DES_EDE_CBC_SHA	TLS_SRP_SHA_3DES_EDE_CBC_SHA1	SRP-3DES-EDE-CBC-SHA	192	26	weak
338	TLS_SRP_SHA_WITH_AES_128_CBC_SHA	TLS_SRP_SHA_AES_128_CBC_SHA1	SRP-AES-128-CBC-SHA	192	29	weak
339	TLS_SRP_SHA_WITH_AES_256_CBC_SHA	TLS_SRP_SHA_AES_256_CBC_SHA1	SRP-AES-256-CBC-SHA	192	32	weak
\.
...
COPY public.company_domain_name_mapping (id, company_id, domain_name_id, creation_date, last_modified) FROM stdin;
\.
...
COPY public.company_network_mapping (id, company_id, network_id, creation_date, last_modified) FROM stdin;
\.
...
--
-- Data for Name: vhost_mapping; Type: TABLE DATA; Schema: public; Owner: kis
--

COPY public.vhost_mapping (id, service_id, host_name_id, creation_date, last_modified) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.cipher_suite_id_seq', 339, true);
...
--
-- Name: vhost_mapping_id_seq; Type: SEQUENCE SET; Schema: public; Owner: kis
--

SELECT pg_catalog.setval('public.vhost_mapping_id_seq', 1, false);
...
--
-- Name: cert_info _cert_info_unique; Type: CONSTRAINT; Schema: public; Owner: kis
--

ALTER TABLE ONLY public.cert_info
    ADD CONSTRAINT _cert_info_unique UNIQUE (service_id, serial_number);
...
--
-- Name: company_domain_name_mapping _company_domain_name_mapping_unique; Type: CONSTRAINT; Schema: public; Owner: kis
--

ALTER TABLE ONLY public.company_domain_name_mapping
    ADD CONSTRAINT _company_domain_name_mapping_unique UNIQUE (company_id, domain_name_id);
...
--
-- Name: vhost_mapping _vhost_mapping_unique; Type: CONSTRAINT; Schema: public; Owner: kis
--

ALTER TABLE ONLY public.vhost_mapping
    ADD CONSTRAINT _vhost_mapping_unique UNIQUE (service_id, host_name_id);
...
--
-- Name: vhost_mapping vhost_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: kis
--

ALTER TABLE ONLY public.vhost_mapping
    ADD CONSTRAINT vhost_mapping_pkey PRIMARY KEY (id);
...
CREATE TRIGGER service_insert AFTER INSERT OR UPDATE ON public.service FOR EACH ROW EXECUTE FUNCTION public.add_services_to_host_name();
...
--
-- Name: vhost_mapping vhost_mapping_host_name_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: kis
--

ALTER TABLE ONLY public.vhost_mapping
    ADD CONSTRAINT vhost_mapping_host_name_id_fkey FOREIGN KEY (host_name_id) REFERENCES public.host_name(id) ON DELETE CASCADE;


--
-- Name: vhost_mapping vhost_mapping_service_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: kis
--

ALTER TABLE ONLY public.vhost_mapping
    ADD CONSTRAINT vhost_mapping_service_id_fkey FOREIGN KEY (service_id) REFERENCES public.service(id) ON DELETE CASCADE;
