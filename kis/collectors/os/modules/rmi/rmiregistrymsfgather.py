# -*- coding: utf-8 -*-
"""
run Metasploit auxiliary module java_rmi_registry on each identified in-scope RMI registry service to perform java
...
from collectors.os.modules.rmi.core import BaseRmiMsfConsole
...
logger = logging.getLogger('rmiregistrymsfgather')


class CollectorClass(BaseRmiMsfConsole, ServiceCollector):
    ...
    def get_service_unreachable_regex() -> List[re.Pattern]:
        ...
        """
        return [re.compile("^.*Auxiliary failed: Rex::ConnectionRefused The connection was refused by the remote host.*$")]
