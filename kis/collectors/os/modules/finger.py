# -*- coding: utf-8 -*-
"""
run tool finger on each identified in-scope finger service (TCP)
"""
...
class FingerServiceDescriptor(ServiceDescriptorBase, ServiceCollector):
    ...
    def __init__(self):
        super().__init__(default_tcp_ports=[79],
                         default_udp_ports=[79],
                         nmap_tcp_service_names=["^finger$"],
                         nmap_udp_service_names=["^finger$"])
