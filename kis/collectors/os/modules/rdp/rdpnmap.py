# -*- coding: utf-8 -*-
"""run tool nmap with all safe NSE scripts on all identified in-scope RDP services"""
...
logger = logging.getLogger('rdpnmap')


class CollectorClass(BaseRdpNmap, ServiceCollector):
    """This class implements a collector module that is automatically incorporated into the application."""

    def __init__(self, **kwargs):
        super().__init__(priority=2500,
                         timeout=0,
                         nmap_xml_extractor_classes=[RdpExtraInfoExtraction],
                         **kwargs)
    ...
    def create_service_commands(self,
        ...
        if self.match_nmap_service_name(service):
            nse_script = ["rdp-enum-encryption", "rdp-ntlm-info"]
