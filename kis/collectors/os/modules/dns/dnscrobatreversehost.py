# -*- coding: utf-8 -*-
"""
run tool Crobat on each collected in-scope IP address to passively perform a reverse DNS lookup.
"""
...
logger = logging.getLogger('dnscrobatreversehost')


class CollectorClass(BaseCrobat, HostCollector):
    """This class implements a collector module that is automatically incorporated into the application."""

    def __init__(self, **kwargs):
        super().__init__(priority=360,
                         timeout=0,
                         delay_min=1,
                         **kwargs)
    ...
    def verify_results(self, session: Session,
        ...
        for line in command.stdout_output:
            ...
            if line:
                ...
                if not host:
                    logger.debug("ignoring host due to invalid IP address: {}".format(line))
