# -*- coding: utf-8 -*-
"""
run tool Crobat on each collected in-scope second-level domain (e.g., megacorpone.com) to passively collect sub-level
domains via sonar.omnisint.io.
"""
...
logger = logging.getLogger('dnscrobatdomain')
