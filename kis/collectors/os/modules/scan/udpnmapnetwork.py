# -*- coding: utf-8 -*-
"""
run tool nmap on all in-scope IPv4/IPv6 networks. valid parameters for this argument are: topX for scanning top X UDP
ports; interesting for scanning interesting UDP ports; all for scanning all UDP ports; or a list of port numbers/
ranges (e.g., 0-1024 8080) to scan just those UDP ports
"""
...
logger = logging.getLogger('udpnmapnetwork')
...
class CollectorClass(BaseNmap, Ipv4NetworkCollector):
    ...
    def create_ipv4_network_commands(self,
        ...
        """
        exclude_hosts_file = []
        arguments = self.get_commandline_argument_value("udpnmapnetwork")
