# -*- coding: utf-8 -*-
"""
run tool rpcinfo on all identified in-scope RPCBIND service
"""
...
from collectors.os.modules.rpc.core import BaseRpcBindCollector
...
class CollectorClass(BaseRpcBindCollector, ServiceCollector):
    """This class implements a collector module that is automatically incorporated into the application."""

    def __init__(self, **kwargs):
        super().__init__(priority=61500,
                         timeout=0,
                         **kwargs)
