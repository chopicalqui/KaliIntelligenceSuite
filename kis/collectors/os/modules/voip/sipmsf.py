# -*- coding: utf-8 -*-
"""
run Metasploit auxiliary module enumerator on each identified in-scope SIP service.
"""
...
from collectors.os.modules.voip.core import BaseSipMsfConsole
...
logger = logging.getLogger('sipmsf')


class CollectorClass(BaseSipMsfConsole, ServiceCollector):
    """This class implements a collector module that is automatically incorporated into the application."""

    def __init__(self, **kwargs):
        super().__init__(priority=4120,
                         timeout=0,
                         **kwargs)
    ...
    def create_service_commands(self,
        ...
        if self.match_nmap_service_name(service):
            if service.protocol == ProtocolType.udp:
