# -*- coding: utf-8 -*-
"""
run tool onesixtyone on each identified in-scope SNMP service where access credentials are known to KIS (use snmphydra
...
class CollectorClass(BaseSnmpCollector, ServiceCollector):
    ...
    def _get_commands(self,
        ...
        if ipv4_address:
            os_command = [command, ipv4_address]
            if community_string:
                os_command.append(community_string)
